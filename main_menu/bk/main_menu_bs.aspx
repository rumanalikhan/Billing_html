...
<%--                    <asp:LinkButton ID="LinkButton1" runat="server" CssClass="tile" OnClick="lnkCoa_Click">--%>
                        ...
                        <div class="desc">Maintenance Billing</div>
                    </asp:LinkButton>
...
<%--                    <asp:LinkButton ID="LinkButton1" runat="server" CssClass="tile" OnClick="lnkCostCenter_Click">--%>
                    ...
                    <asp:LinkButton ID="LinkButton1" runat="server" CssClass="tile">
<%--                    <asp:LinkButton ID="LinkButton1" runat="server" CssClass="tile" OnClick="lnkCostCenter_Click">--%>
                        <div class="title">Rental</div>
                        <div class="desc">Dimensions</div>
                    </asp:LinkButton>

                    <asp:LinkButton ID="LinkButton2" runat="server" CssClass="tile">
<%--                    <asp:LinkButton ID="LinkButton1" runat="server" CssClass="tile" OnClick="lnkCostCenter_Click">--%>
