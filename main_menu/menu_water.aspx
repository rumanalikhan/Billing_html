<%@ Page Language="C#" AutoEventWireup="true" CodeFile="menu_water.aspx.cs" Inherits="menu_water" %>
...
<head id="Head1" runat="server">
    ...
    <title>Bahria Town Karachi (Water Billing)</title>
...
<form id="form1" runat="server">
    ...
    <header>
        <div style="width:10%; font-weight:600;">WATER BILLING</div>
    ...
    <div class="wrap">
        ...
        <div class="columns">
            ...
            <div class="column">
                ...
                <asp:Button ID="btnUoloadCSV" runat="server" CssClass="menu-button"
                    Text="Upload Reading" OnClick="btnUoloadCSV_Click" />

                <asp:Button ID="btnUpdateBills" runat="server" CssClass="menu-button"
                    Text="Update Bills" OnClick="btnUoloadCSV_Click" />
            </div>
            ...
            <div class="column">
                ...
                <asp:Button ID="btnArrears" runat="server" CssClass="menu-button"
                    Text="Arrears Upload" OnClick="btnArrears_Click" />

                <asp:Button ID="btnAdvances" runat="server" CssClass="menu-button"
                    Text="Advances Upload" OnClick="btnAdvances_Click" />
            </div>
