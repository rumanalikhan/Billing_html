<%@ Page Language="C#" AutoEventWireup="true"
    CodeFile="maint_bill_generate.aspx.cs"
    Inherits="maint_bill_generate" %>

<!DOCTYPE html>
<html lang="en">
    <head id="Head1" runat="server">
        <meta charset="UTF-8" />
        <title>Maintenance Bill Generate</title>
        ...
        <form id="form1" runat="server">
            <div class="container">
                ...
                <div class="form-panel">
                    <h2>Maintenance Bill Generate</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <label>Billing Trend</label>
                            <asp:TextBox ID="lblTrend"
                                         runat="server"
                                         CssClass="asp-input readonly-box"
                                         ReadOnly="true" />
                        </div>
                    </div>
