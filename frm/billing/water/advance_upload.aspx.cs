...
public partial class advance_upload : System.Web.UI.Page
{
    string connStr = WebConfigurationManager.ConnectionStrings["MyDbConnectionWTR"].ConnectionString;
        ...
        try
            {
                using (OracleConnection con = new OracleConnection(connStr))
                {
                    ...
                    using (OracleCommand cmdTrn =
                        new OracleCommand("TRUNCATE TABLE BIL_ADVANCE_BK", con))
                    {
                    ...
                    using (StreamReader sr = new StreamReader(fuCsv.FileContent))
                    {
                        ...
                        while ((line = sr.ReadLine()) != null)
                        {
                            ...
                            using (OracleCommand cmdIns =
                                new OracleCommand(@"INSERT INTO BIL_ADVANCE_BK (RES_ID, AMT, UPDATE_TYPE) VALUES (:RES_ID, :AMT, 'P')", con))
                            {
