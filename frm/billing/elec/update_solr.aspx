<%@ Page Language="C#" AutoEventWireup="true" CodeFile="update_solr.aspx.cs" Inherits="update_solr" %>
...
<%--                        <div class="btn-row">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <asp:TextBox ID="txtUnitRate" runat="server" CssClass="asp-input" Style="border: 2px solid black; border-radius: 4px;" ReadOnly="true"/>
                        </div>
                        <div class="col">
                            <label>Amount (K1)</label>
                    ...
                    <div class="row">
                        <div class="col">
                            <label>Read K2 From</label>
                            <asp:TextBox ID="txtK2From" runat="server" CssClass="asp-input" Style="border: 2px solid blue; border-radius: 4px;" />
                        </div>
                        <div class="col">
                            <label>Read K2 To</label>
                            <asp:TextBox ID="txtK2To" runat="server" CssClass="asp-input" Style="border: 2px solid blue; border-radius: 4px;" />
                        </div>
                        <div class="col">
                            <label>Total Units</label>
                            <asp:TextBox ID="txtSlDiff" runat="server" CssClass="asp-input" Style="border: 2px solid black; border-radius: 4px;" ReadOnly="true"/>
                        </div>
                        <div class="col">
                            <label>Units Adjusted</label>
                            <asp:TextBox ID="txtUnitAdj" runat="server" CssClass="asp-input" Style="border: 2px solid blue; border-radius: 4px;" />
                        </div>
                        <div class="col">
                            <label>Adj. Rates</label>
                            <asp:TextBox ID="txtAdjRate" runat="server" CssClass="asp-input" Style="border: 2px solid black; border-radius: 4px;" ReadOnly="true"/>
                        </div>
                        <div class="col">
                            <label>Amount (K2)</label>
                            <asp:TextBox ID="txtK2Amt" runat="server" CssClass="asp-input" Style="border: 2px solid black; border-radius: 4px;" ReadOnly="true"/>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <label>NEPRA RATE</label>
                            <asp:TextBox ID="txtFixedRate" runat="server" CssClass="asp-input" Style="border: 2px solid blue; border-radius: 4px;" />
                        </div>
                        <div class="col">
                            <label>Unit Adj</label>
                            <asp:TextBox ID="txtNetUnit" runat="server" CssClass="asp-input" Style="border: 2px solid blue; border-radius: 4px;" />
                        </div>
                        <div class="col">
                            <label>Unit Pruchase</label>
                            <asp:TextBox ID="txtUnitPurchase" runat="server" CssClass="asp-input" Style="border: 2px solid black; border-radius: 4px;" ReadOnly="true"/>
                        </div>
                        <div class="col">
                            <label>Amount (K3)</label>
                            <asp:TextBox ID="txtK3Amt" runat="server" CssClass="asp-input" Style="border: 2px solid blue; border-radius: 4px;" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <asp:TextBox ID="txtTltAmt" runat="server" CssClass="asp-input" Style="border: 2px solid blue; border-radius: 4px;" />
                        </div>
                        <div class="col">
                            <label>Previous Balance</label>
                            <asp:TextBox ID="txtPrevBal" runat="server" CssClass="asp-input" Style="border: 2px solid blue; border-radius: 4px;" />
                        </div>
                        <div class="col">
                            <label>Qtr-1</label>
                            <asp:TextBox ID="txtQtr1" runat="server" CssClass="asp-input" Style="border: 2px solid black; border-radius: 4px;" ReadOnly="true"/>
                        </div>
                        <div class="col">
                            <label>Qtr-2</label>
                            <asp:TextBox ID="txtQtr2" runat="server" CssClass="asp-input" Style="border: 2px solid blue; border-radius: 4px;" />
                        </div>
                        <div class="col">
                            <label>Qtr-3</label>
                            <asp:TextBox ID="txtQtr3" runat="server" CssClass="asp-input" Style="border: 2px solid black; border-radius: 4px;" ReadOnly="true"/>
                        </div>
                        <div class="col">
                            <label>Qtr-4</label>
                            <asp:TextBox ID="txtQtr4" runat="server" CssClass="asp-input" Style="border: 2px solid blue; border-radius: 4px;" />
                        </div>
                        <div class="col">
                            <label>Total Amt</label>
                            <asp:TextBox ID="txtTotAmt" runat="server" CssClass="asp-input" Style="border: 2px solid blue; border-radius: 4px;" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <asp:TextBox ID="txtONMCharges" runat="server" CssClass="asp-input"  ReadOnly="true"/>
                        </div>
                        <div class="col">
