    ...
    <head id="Head1" runat="server">
        ...
        <style>
            ...
            .blue-border {
                ...
                border-radius: 4px;
                padding: 4px; /* optional for better spacing */
            }
        </style>
    </head>
    ...
    <script type="text/javascript">
     ...
     <body>
        <form id="form1" runat="server">
            ...
            <div class="container">
<%--                <div id="header_user" style="width:56%;text-align:center;">
                    <asp:Label ID="lblUser" runat="server" ForeColor="Blue"></asp:Label>
                </div>--%>
                ...
                <div class="form-panel">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <asp:TextBox ID="txtK1From" runat="server" CssClass="asp-input" Style="border: 2px solid blue; border-radius: 4px;" onkeydown="return Common_KeyDown(event, this);" />
<%--                            <asp:Button ID="btnReCalculateBill0" runat="server" Text="ReCalculateBill0" OnClick="pcdReCalculateBill" Style="display:none" />--%>
                        </div>
                        <div class="col">
                            <label>Read K1 To</label>
                            <asp:TextBox ID="txtK1To" runat="server" CssClass="asp-input" Style="border: 2px solid blue; border-radius: 4px;" onkeydown="return Common_KeyDown(event, this);" />
                        </div>
                        <div class="col">
                        ...
                        <div class="col">
                            ...
                            <asp:TextBox ID="txtMFactor" runat="server" CssClass="asp-input" Style="border: 2px solid blue; border-radius: 4px;" onkeydown="return Common_KeyDown(event, this);" />
                        </div>
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                            <label>Advance</label>
                            <asp:TextBox ID="txtAdvance" runat="server" CssClass="asp-input" Style="border: 2px solid blue; border-radius: 4px;" onkeydown="return Common_KeyDown(event, this);" />
                        </div>
                        <div class="col">
                            <label>Arrear</label>
                            <asp:TextBox ID="txtArrear" runat="server" CssClass="asp-input" Style="border: 2px solid blue; border-radius: 4px;" onkeydown="return Common_KeyDown(event, this);" />
                        </div>
                        <div class="col">
                            <label>Instalment</label>
                            <asp:TextBox ID="txtInstalment" runat="server" CssClass="asp-input" Style="border: 2px solid blue; border-radius: 4px;" onkeydown="return Common_KeyDown(event, this);" />
                        </div>
                        <div class="col">
                            <label>Fine</label>
                            <asp:TextBox ID="txtFine" runat="server" CssClass="asp-input" Style="border: 2px solid blue; border-radius: 4px;" onkeydown="return Common_KeyDown(event, this);" />
                        </div>
                        <div class="col">
                            <label>DC Charges</label>
                            <asp:TextBox ID="txtDcCharges" runat="server" CssClass="asp-input" Style="border: 2px solid blue; border-radius: 4px;" onkeydown="return Common_KeyDown(event, this);" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <label>Remarks</label>
                            <asp:TextBox ID="txtRemarks" runat="server" CssClass="asp-input" Style="border: 2px solid blue; border-radius: 4px;" onkeydown="return Common_KeyDown(event, this);" />
                        </div>
                    </div>
