...
.indent-4 { padding-left: 60px; }
    ...
    .report-table th:nth-child(2) { width: 28%; }
    ...
    .report-table th:nth-child(7) { width: 8%; }
    .report-table th:nth-child(8) { width: 8%; }
    ...
    <form id="form1" runat="server">
        ...
        <div class="report-container">
            ...
            <div class="report-period">
                OPENING AS ON: <asp:Label ID="lblOpeningDate" runat="server" /> &nbsp;|&nbsp;
                FOR THE PERIOD: <asp:Label ID="lblFromDate" runat="server" /> TO <asp:Label ID="lblToDate" runat="server" />
            </div>

            <!-- Main Table with Two Header Rows using separate header table -->
