<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GL_Payment_Voucher.aspx.cs" Inherits="GL_Payment_Voucher" %>
        ...
        function setupGLAutoComplete() {
            $('.gl-code-input').autocomplete({
                source: function (request, response) {
                    $.ajax({
                        type: "POST",
                        url: "GL_Payment_Voucher.aspx/SearchGLCodes",
        ...
        function setupSLAutoComplete() {
            ...
            $('.sl-code-input').autocomplete({
                source: function (request, response) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "GL_Payment_Voucher.aspx/SearchSLCodes",
            ...
            <div class="voucher-header">
                <table>
                    <tr>
                        ...
                        <td class="header-label">GPV:</td>
                        <td class="header-value">
                            <asp:Label ID="lblgpv" runat="server" Text="Auto-generated" CssClass="voucher-key" />
                        </td>
                    </tr>
                </table>
            </div>
