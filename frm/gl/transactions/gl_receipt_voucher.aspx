...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <header>
                <div style="font-weight:bold; font-size:18px;">Bank Receipt Voucher</div>
                ...
                <asp:GridView ID="gvVoucherDetails" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="SL Code" HeaderStyle-CssClass="col-sl-code">
                            <ItemTemplate>
                                <asp:TextBox ID="txtSLCode" runat="server" CssClass="sl-code-input"
                                    Text='<%# Bind("SL_CODE") %>' AutoPostBack="true"
                                    OnTextChanged="txtSLCode_TextChanged" placeholder="SL Code" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="SL Description" HeaderStyle-CssClass="col-sl-type">
                            <ItemTemplate>
                                <asp:TextBox ID="txtSLType" runat="server" CssClass="sl-type-input"
                                    Text='<%# Bind("SL_TYPE") %>' placeholder="SL Description"
                                    ReadOnly="true" Style="background-color: #f0f0f0;" />
                            </ItemTemplate>
                        </asp:TemplateField>
