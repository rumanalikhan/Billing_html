<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cost_centre.aspx.cs" Inherits="cost_centre" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <header>
            <div style="font-weight:bold; font-size:18px;">Cost Center Management</div>
        ...
        <div class="container">
            ...
            <div class="left-panel">
                <h3>Cost Center Management</h3>
                <ul>
                    <li>Cost Center Code is auto-generated</li>
                    <li>Enter Cost Center Description</li>
                    <li>Click Save to create cost center</li>
                </ul>
                <div style="margin-top: 20px; padding: 10px; background: rgba(255,255,255,0.2); border-radius: 5px;">
                    <small><strong>Note:</strong> Cost Center Code is automatically generated and cannot be edited</small>
                </div>
            </div>
            ...
            <div class="right-content">
                ...
                <asp:HiddenField ID="hfCostCentreCode" runat="server" Value="0" />

                <!-- MAIN FORM PANEL -->
                <div class="form-panel">
                    <div class="panel-header">Cost Center Details</div>
                    
                    <table class="form-table">
                        <tr>
                            <td class="label-cell">Cost Center Code <span style="color:red;">*</span>:</td>
                            <td class="value-cell">
                                <asp:TextBox ID="txtCostCentreCode" runat="server" CssClass="asp-input w-150 readonly-field auto-generated" 
                                    ReadOnly="true" />
                            </td>
                        ...
                        <tr>
                            <td class="label-cell">Cost Center Description <span style="color:red;">*</span>:</td>
                            <td colspan="3">
                                <asp:TextBox ID="txtDescription" runat="server" CssClass="asp-input w-full" 
                                    MaxLength="50" placeholder="Enter Cost Center Description" />
                            </td>
                        </tr>
                    </table>

                    <div class="button-group">
                        <asp:Button ID="btnSave" runat="server" Text="Save Cost Center" CssClass="btn btn-save" OnClick="btnSave_Click" />
                ...
                <!-- EXISTING COST CENTERS GRID -->
                <%--<div class="card">
                    <h3>Existing Cost Centers</h3>
                    <div class="grid-container">
                        <asp:GridView ID="gvCostCentres" runat="server" CssClass="gridview-style" AutoGenerateColumns="False" 
                            OnRowCommand="gvCostCentres_RowCommand" DataKeyNames="COST_CENTRE_CODE">
                            <Columns>
                                <asp:BoundField DataField="COST_CENTRE_CODE" HeaderText="Code" ItemStyle-Width="100px" />
                                <asp:BoundField DataField="COST_CENTRE_DESCRP" HeaderText="Description" />
                                <asp:TemplateField HeaderText="Actions" ItemStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" runat="server" CommandName="EditRow" 
                                            CommandArgument='<%# Eval("COST_CENTRE_CODE") %>' Text="Edit" 
                                            Style="color: #2196F3; text-decoration: none;" />
                                        <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteRow" 
                                            CommandArgument='<%# Eval("COST_CENTRE_CODE") %>' Text="Delete" 
                                            Style="color: #f44336; text-decoration: none; margin-left: 10px;"
                                            OnClientClick="return confirm('Delete this cost center?');" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <EmptyDataTemplate>
                                <div style="padding: 20px; text-align: center;">No cost centers found</div>
                            </EmptyDataTemplate>
                        </asp:GridView>
                    </div>
                </div>--%>
