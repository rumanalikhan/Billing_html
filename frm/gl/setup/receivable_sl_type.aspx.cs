...
public partial class receivable_sl_type : System.Web.UI.Page
{
    ...
    protected void gvBulkSL_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (hfGLCode != null)
            {
                ...
                // HiddenField doesn't have CssClass - removed that line
            }
        ...
        try
        {
            ...
            using (OracleConnection conn = new OracleConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    ShowSnackbarMessage("Receivable SL Type saved successfully!", "success");
    ...
    // Add this method to get the next available ID for display
    [System.Web.Services.WebMethod]
