<%@ Page Language="C#" AutoEventWireup="true" CodeFile="receivable_sl_type.aspx.cs" Inherits="receivable_sl_type" %>
...
<head id="Head1" runat="server">
    <meta charset="UTF-8" />
    <title>Receivable SL Type</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <header>
            <div style="font-weight:bold; font-size:18px;">Receivable SL Type</div>
        ...
        <div class="container">
            ...
            <div class="left-panel">
                <h3>Receivable SL Type Management</h3>
                <ul>
        ...
        <script type="text/javascript">
            ...
            function setupGLAutoComplete() {
                $('#<%= txtGLCode.ClientID %>').autocomplete({
                    source: function (request, response) {
                        $.ajax({
                            type: "POST",
                            url: "receivable_sl_type.aspx/SearchGLCodes",
            ...
            function addGridRow() {
                ...
                // Clear auto ID label (will be updated when saving)
                ...
                // Setup autocomplete for the new row's GL Code input
            ...
            function collectGridData() {
                ...
                for (var i = 1; i < grid.rows.length; i++) {
                    var row = grid.rows[i];
                    var glCode = $(row).find('.glcode-input').val().trim();
                    var description = $(row).find('input[id*="txtDescription"]').val().trim();
                    
                    if (glCode !== '' && description !== '') {
                        rows.push({ GL_CODE: glCode, DESCRIPTION: description });
                    }
                }
                return rows;
            }
            ...
            $(document).ready(function () {
                ...
                // Setup autocomplete for existing grid rows
